    ...
    <div class="container">
        ...
        <table class="w-full border border-gray-300 text-left">
            ...
            <tbody>
                        ...
                        <td class="p-2 border">
                            ...
                            <div x-data="{ openEdit: false, role: '{{ $user->role }}' }" class="inline-block">
                                ...
                                <div x-show="openEdit" x-cloak
                                    ...
                                    <div class="bg-white p-6 rounded shadow-lg w-full max-w-2xl overflow-auto max-h-[90vh]">
                                        <h2 class="text-lg font-semibold mb-4">Editar Usuario</h2>

                                        <form action="{{ route('admin.user.update', auth()->id()) }}" method="POST"
                                            enctype="multipart/form-data" class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="relative mb-8">
                                                ...
                                                <div class="absolute -bottom-10 left-1/6 transform -translate-x-1/2">
                                                    <img id="fotoPerfilPreview"
                                                        ...
                                                        alt="Foto de perfil">
                                                    <input type="file" name="foto_perfil" id="fotoPerfilInput" accept="image/*"
                                                        class="hidden">
                                                </div>
                                            </div>
                            ...
                            <div x-data="{ open: false }" class="inline-block">
                                <button @click="open = true" class="text-red-500 hover:underline">Eliminar</button>

                                <div x-show="open" x-cloak
                                    class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                                    <div class="bg-white p-6 rounded shadow-lg w-full max-w-md">
                                        <h2 class="text-lg font-semibold mb-4">¿Estás seguro?</h2>
                                        <p class="mb-4">Esta acción eliminará al usuario <strong>{{ $user->name }}
                                                {{ $user->last_name }}</strong> de forma permanente.</p>
                ...
                @empty
                    <tr>
                        <td colspan="6" class="p-4 text-center">No hay usuarios registrados.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>

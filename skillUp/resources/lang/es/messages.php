...
return [
    ...
    'admin' => [
        ...
        'projects' => [
            ...
            'delete-text-1' => 'Esta accion eliminará el proyecto',
        ...
        'teachers' => [
            'heading-confirm' => '¿Estás seguro?',
            'import-confirm' => '¿Quieres importar profesores desde este archivo?',
            'selected-file' => 'Archivo seleccionado: ',
            'import-failed' => 'Error al importar profesores',
            'import-success' => 'Profesores importados correctamente.',
        ],
        'import-teachers' => 'Importar profesores',
        'students-format' => 'Recuerda el formato: Nombre;Apellido;Correo;Fecha de nacimiento(AAAA-MM-DD);Curso actual',
    ...
    'project-details' => [
        ...
        'title-school' => 'Detalles del proyecto escolar',
        'author' => 'Autor: ',
        'published' => 'Publicado el: ',
        'created-at' => 'Realizado el: ',
        'link' => 'Enlace: ',
        'project-files' => 'Archivos del proyecto:',
        'no-files' => 'No hay archivos por el momento',
        'comments' => 'Comentarios',
        'add-comment' => 'Añadir comentario',
        'write-comment' => 'Escribe tu comentario aquí...',
    ...
    'apply-form' => [
        ...
        'position-applied' => 'Puesto solicitado: ',
        'application-reason' => 'Motivo de la aplicación: ',
        'cv' => 'Currículum: ',
        'upload-cv' => 'Subir currículum',
        'state' => 'Estado: ',
    ],
    'from' => 'de ',
    'answer' => 'Responder',
    ...
    'messages' => [
        ...
        'comment-delete' => 'Comentario eliminado correctamente',
        'user-create' => 'Usuario creado correctamente',
        'project-create' => 'Proyecto creado correctamente',
        'job-offer-create' => 'Oferta de trabajo creada correctamente',
        'sp-create' => 'Proyecto escolar creado correctamente',
        'offer-update' => 'Oferta de trabajo actualizada correctamente',
        'offer-delete' => 'Oferta de trabajo eliminada correctamente',
        'sp-update' => 'Proyecto escolar actualizado correctamente',
        'sp-delete' => 'Proyecto escolar eliminado correctamente',
        'project-update' => 'Proyecto actualizado correctamente',
        'project-delete' => 'Proyecto eliminado correctamente',
        'candidate-create' => 'Candidatura creada correctamente',
        'candidate-delete' => 'Candidatura eliminada correctamente',
        'candidate-update' => 'Candidatura actualizada correctamente',
        'comment-create' => 'Comentario creado correctamente',
        'comment-edit' => 'Comentario editado correctamente',
        'offer-create' => 'Oferta de trabajo creada correctamente',
